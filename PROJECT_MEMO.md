...
4. 30건 넘는 다이제스트를 스캔 가능한 밀도로 읽을 수 있다 — ❌ **T3.3 만 남았다**(T3.1 은 완료).

즉 **남은 건 4번 하나, 디자인·밀도 패스(T3.3)뿐이다.** LLM/수집 쪽은 손댈 게 없다.
...
| **T3.3** | 밀도·시각 폴리시 패스 (설계 Phase 6) — ⏸ **사용자 캔버스 대기 중** | 2026-07-31 사용자 결정: **새 Claude Design 캔버스를 만든 뒤 DesignSync 로 통합**한다(내가 임의로 디자인하지 않음). 착수 전 실측/정정은 완료 → **`docs/design-brief-2026-07-31.md`** 에 정리. 디자인 무관한 부분(아카이브 제목)은 이미 처리 | 캔버스 1개 + 통합 |
